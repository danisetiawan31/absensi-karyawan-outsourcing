...
- **Error Codes:** `AKUN_NONAKTIF`, `TERLALU_BANYAK_PERCOBAAN` (429, rate limit 5x/60 detik per IP)
...
- **Response:** `{ "success": true }`
- **Error Codes:** `TERLALU_BANYAK_PERCOBAAN` (429, rate limit 3x/5 menit per IP)
