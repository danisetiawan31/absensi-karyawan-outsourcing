...
| E2  | Cron: reminder T+5 menit belum check-in (ke Karyawan)                              | Butuh data check-in beneran buat tau siapa yang "belum check-in" — depend ke Track C3 (belum ada).                                                                                                            | `READY`                   |
| E3  | Cron: alert T+15 menit (ke Supervisor) + auto-mark `TIDAK_HADIR`                   | Sama kayak E2, butuh data `LogKehadiran`/`PercobaanAbsensi` real — depend ke C3.                                                                                                                              | `READY`                   |
